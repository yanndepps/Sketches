...
const fragment = require("../shaders/sketch_047/fragment.glsl");
const vertex = require("../shaders/sketch_047/vertex.glsl");
...
const sketch = ({ context }) => {
  ...
  const texture = loader.load([
    "../assets/sketch_047/res/Cold_Sunset__Cam_2_Left+X.png",
    "../assets/sketch_047/res/Cold_Sunset__Cam_3_Right-X.png",
    "../assets/sketch_047/res/Cold_Sunset__Cam_4_Up+Y.png",
    "../assets/sketch_047/res/Cold_Sunset__Cam_5_Down-Y.png",
    "../assets/sketch_047/res/Cold_Sunset__Cam_0_Front+Z.png",
    "../assets/sketch_047/res/Cold_Sunset__Cam_1_Back-Z.png",
  ]);
